...
// 다른 패키지에 있기 때문에 import가 불가 하다.
// 'edu.kh.oop.cls.model.vo.TestVO' is not public in 'edu.kh.oop.cls.model.vo'. Cannot be accessed from outside package
...
//        System.out.println(v4);
    ...
    public void ex2(){
        ...
        System.out.println("std3 : "+std3.schoolName); // KH고등학교 (X) -> KH정보교육원
        ...
        static 역역에 생성되고, 프로그램이 종료될 때 까지 사라지지 않음 (정적)
    ...
    public void ex3(){
        ...
        //         why? 같은 기본 생성자 User 객체를 생성했기 때문에
