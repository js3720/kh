...
<header>
	...
	<section>
		<a href="${contextPath}"> 
			...
			* 지금처럼 부리시켜둔 jsp에 경로를 지정하는 경우
			상대경로는 무제가 발생할 가능성이 높음!!!
			-> 절대경로 사용!!!!! 
			...
			<%--
			절대경로 : /community
			스크립틀릿 : <%= request.getContextPath() %>
			EL : ${ pageContext.servletContext.contextPath }
			...
			<img src="${contextPath}/resources/images/kh-logo.jpg" id="home-logo">
		</a>
	</section>
