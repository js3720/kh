...
public class LoginServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 요청 시 전잘된 input 태그의 값(== Parmeter) 얻어오기
		...
		String result = null;
		result = inputId.equals("user01")&& inputPw.equals("pass01!") ? inputId+"님이 로그인 하셨습니다." : "아이디 또는 비밀번호가 일치하지 않습니다.";
		...
		// *** JSP 경로 작성 규칙 ***
		// -webapp 폴더를 기준으로 해서 JSP파일까지의 모든 경로를 작성!!!
