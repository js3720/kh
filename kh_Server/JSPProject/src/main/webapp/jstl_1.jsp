...
<body>
    ...
    <pre>
        ...
        prefix : 접두사. 다른 태그와 구별할 수 있는 namespace
            ...
            url(Unniform Resource Locator) : 인터넷에서 특정 자원 위치 지정(주소)
            uri(Unniform Resource Indentifier) : 네트워크 상에서 자원을 구별하는 식별자
                                        (자원을 구분하는 유일한 주소)
