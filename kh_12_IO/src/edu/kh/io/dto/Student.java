...
// --> ObjectOutputStream이 객체를 내보낼 때 해당 인터페이스를
//     상속받은 객체인 경우만 직렬화 작업을 진행한다.

// Serializable을 상속했지만 구현할 메소드가 없다! == 마커 인터페이스 (표시 용도의 인터페이스)
public class Student implements Serializable {
    private static final long serialVersionUID = 123423434321L;
    private String name;
    private int grade;
