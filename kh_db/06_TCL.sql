...
/* TRANSACTION이란?
 ...
 EX) INSERT 수행 -------------------------------> DB 반영(X)
     ...
     INSERT 10번 수행 --> 1개 트랜잭션에 10개 추가 --> ROLLBACK --> DB에 반영 안됨
     
     1) COMMIT : 메모리 버퍼(트랜잭션)에 임시 저장된 데이터 변경 사항을 DB 반영
