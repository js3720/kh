...
INSERT INTO EMPLOYEE2 VALUES(900,'김종수','941228-1000000','JS3720@KH.COM','01037204583',
...
VALUES(900,'김종수','941228-1000000','JS3720@KH.COM','01037204583',
    'D1','J7','S3',500000000);
...
WHERE DEPT_ID = 'D9' AND DEPT_TITLE = '전략기획2팀';
...
SELECT * FROM EMPLOYEE2 WHERE EMP_NAME='윤은해';

-- EMPLOYEE2 테이블에서 '윤은해' 사원 정보 삭제
DELETE FROM EMPLOYEE2 WHERE EMP_NAME='윤은해';
--삭제 확인
SELECT * FROM EMPLOYEE2;
ROLLBACK;
