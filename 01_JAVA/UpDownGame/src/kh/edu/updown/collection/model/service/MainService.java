...
public class MainService {
    ...
    public void signUp() {
        ...
        while(true){
            ...
            id = sc.next();
            for(Member m : members) if(m.getMemberId().equals(id)) flag = true;
            if(flag) System.out.println("중복되는 아이디가 존재 합니다. 다시 입력해주세요");
            else break;
        }
        ...
        System.out.println(name+"님 회원가입 감사합니다");
    }
    ...
    public void login() {
        ...
        System.out.println( flag ? "아이디 또는 비밀번호가 일치하지 않습니다." : loginMember.getMemberName()+"님 환영합니다.");
    }
}