...
$("#input1").on("input", function(){
    ...
    if( regExp.test($("#input1").val() )){
        ...
        $("#span1").text("유효하지 않은 문자열 형식입니다.")
        .css("color","red");
        // method chaining : 하나에 대상에 대하여 여러 메소드를 연달아 작성하는 기술
    }
    //$("#span1").text(regExp.test($(this).val()) ? "유효한 문자열 형식입니다." : "유효하지 않은 문자열 형식입니다.").css("color",regExp.test($(this).val()) ? "green" : "red");
})
...
$(function(){
    ...
    $(".area>ul>.qqq").css("backgroundColor","blue");
