...
document.getElementById("btn3-1").addEventListener("click", function(){
    if(plus<=10) document.getElementById("div3-1").innerHTML += "<div>"+ plus++ +"</div>";
})
