...
public class VariableExample1 {
    ...
    public static void main(String[] args) {
        // 변수 미사용
        System.out.println(2 * 3.141592653579893 * 10);
        System.out.println(3.141592653579893 * 10 * 10);
        System.out.println(3.141592653579893 * 10 * 10 * 20);
        System.out.println(4 * 3.141592653579893 * 10 * 10);

        // 변수 사용
        double pi = 3.141592653579893; //원주율
        int r = 10; // 반지름(radius)
        int h = 20; // 높이 (height)
