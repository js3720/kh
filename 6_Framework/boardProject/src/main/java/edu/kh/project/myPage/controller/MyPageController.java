...
public class MyPageController {
	...
	// 회원 정보 수정
	@PostMapping("/info")
	public String info(Member updateMember, String[] memberAddress, Model model
	...
	public String changePw( String currentPw, String newPw, @SessionAttribute("loginMember") Member loginMember
			, RedirectAttributes ra) {
		// 매개변수와 Name 속성값이 같을 때는 생략가능 (@RequestParam("currentPw"))
	...
	public String updateProfile(
			...
			,@SessionAttribute("loginMember") Member loginMember // 로그인한 회원정보
...
//		else message = "프로필 변경 실패";
		String message = result>0 ? "프로필 이미지가 변경되었습니다." : "프로필 변경 실패";
