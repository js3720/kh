...
public class MemberController {
	...
	public String login(/*@RequestParam("inputEmail") */String inputEmail,
		...
		// 파라미터 전달 방법 2 : @RequestParam 어노테이션을 이용 ( + 생략 방법)
	...
	public String login(/*@ModelAttribute*/ Member inputMember) {
		...
		// 파라미터 전달방법 3 : @ModelAttribute를 이용한 방법
		...
		// - DTO에 기본 생성자가 핋수로 존재해야 한다!
		// - DTO에 setter가 필수로 존재해야 한다!
		
		// *** @ModelAttribute 어노테이션은 생략이 가능하다! *** 
		
		// *** @ModelAttribute를 이용해 값이 필드에 셋팅된 객체를 "커맨드 객체" 라고 한다 ***
	...
	public String login(Member inputMember, Model model
		...
		// @RequestHeader(value="referer") String referer
		// -> 요청 HTTP header에서 "referer"(이전주소) 값을 얻어와서
