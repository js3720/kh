...
-- 비밀번호 변경
UPDATE "MEMBER" SET
MEMBER_PW = '$2a$10$6jFMQ0YM7eIzqHvckFJfYOLsdvdtxWgpfDOtO49/s3mfvywaBShRi'
;
COMMIT;
...
SELECT COUNT(*)
FROM MEMBER
WHERE MEMBER_EMAIL = 'js3720@naver.com'
AND MEMBER_DEL_FL = 'N';
...
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
   '202308211141913_00001.png', 'cat1.png', 0, 1490);
   
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
   '202308211141913_00002.png', 'cat2.png', 0, 1385);
   
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
   '202308211141913_00003.png', 'cat3.png', 0, 1440);

INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
   '202308211141913_00004.png', 'cat4.png', 0, 1300);
   
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
   '202308211141913_00005.png', 'cat5.png', 0, 1311);
...
-- 일반적으로 이렇게 사용해야하는데 마이바티스에서는 위에 구문처럼 사용 가능
SELECT * FROM(
    SELECT A.* FROM(
...
-- 게시글 좋아요  샘플데이터 삽입
INSERT INTO BOARD_LIKE VALUES(1500,4);
...
-- 회원 프로필 이미지 변경
UPDATE MEMBER SET
PROFILE_IMG = '/resources/images/member/mungmung.jpg'
WHERE MEMBER_NO = 4;
...
-- 댓글 더미데이터 삽입 (댓글번호, 댓글내용, 작성시간, 삭제여부, 게시글번호, 회원번호, 부모댓글번호 )
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모댓글 1', DEFAULT, DEFAULT, 1512, 4, NULL);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모댓글 2', DEFAULT, DEFAULT, 1512, 4, NULL);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식댓글 1-1', DEFAULT, DEFAULT, 1512, 4, 1010);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식댓글 1-2', DEFAULT, DEFAULT, 1512, 4, 1010);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식댓글 1-3', DEFAULT, DEFAULT, 1512, 4, 1010);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식댓글 2-1', DEFAULT, DEFAULT, 1512, 4, 1011);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식댓글 2-2', DEFAULT, DEFAULT, 1512, 4, 1011);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식댓글 2-1-1', DEFAULT, DEFAULT, 1512, 4, 1016);
